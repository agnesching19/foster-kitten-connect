...
export function GoogleSheetsImportCard() {
  ...
  return (
    <Card>
      ...
      <p className="mt-3 text-xs text-muted">
        ...
        CSV) and use the Import CSV card below — the same validation, preview and duplicate handling
        applies.
      </p>
    </Card>
  )
