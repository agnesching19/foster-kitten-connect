...
export const Route = createFileRoute('/litter')({
  head: () => ({
    meta: [
      { title: 'Litter Box Log | Kitty Tracker' },
      {
        name: 'description',
        content: 'See when the litter box was last changed and the full maintenance history.',
      },
      { property: 'og:title', content: 'Litter Box Log | Kitty Tracker' },
      {
